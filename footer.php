    ...
    <div class="footer-col">
      <div class="link-section">
        ...
        <span style="color: white; font-family: 'Roboto', sans-serif; font-size: 33px; font-weight: bold; letter-spacing: 1.75px;">NORIKS</span>
              ...
              <p class="footer-brand-dec" style="padding-right: 100px; font-size:12px;" >NORIKS е създаден, за да реши един прост, но често пренебрегван проблем: повечето мъже нямат дрехи, които наистина им стоят добре. От разочарованието от къси, тесни и зле проектирани базови артикули, NORIKS проектира вечни дрехи за по-едри телосложения – по-дълги, по-удобни и внимателно проектирани там, където е най-необходимо.
</p>
      </div>
    </div>
