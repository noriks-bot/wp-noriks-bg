  ...
  <div style="max-width: 1440px;" class="container why-container">
    ...
    <div class="why-col">
      <div class="video-wrapper">
          <img style="" src="https://noriks.com/bg/wp-content/uploads/2026/01/starter-1_GR.png">
      </div>
    </div>
...
<section style="background: white;" class="why-section">
   <div style="max-width: 1440px;" class="container why-container">
    ...
    <div class="why-col">
      <div class="video-wrapper">
           <img style="" src="https://noriks.com/bg/wp-content/uploads/2026/01/starter-2_gr.png">
      </div>
    </div>
...
ΣΥΝΔΥΑΣΜΟΣ ΠΟΥ ΦΟΡΑΙΣ ΚΑΘΕ ΜΕΡΑ
      ...
      <div style="margin-left: 20px;" class="why-point">
        ...
        <p class="description">Тениската и боксерките са направени за носене от сутрин до вечер, без настройки и дискомфорт. Всичко остава на мястото си, не стяга и позволява свободно движение през целия ден.
      ...
      <div style="margin-left: 20px;" class="why-point">
        ...
        <p class="description">Кройката на тениската подчертава горната част на тялото, докато боксерките осигуряват достатъчно пространство и стабилност, без да се качват нагоре. Резултатът е уверено, спокойно усещане и спретнат вид при всяка ситуация.
...
<section class="why-section">
   <div style="max-width: 1440px;" class="container why-container">
    ...
    <div class="why-col">
      <div class="video-wrapper">
          <img style="" src="https://noriks.com/bg/wp-content/uploads/2026/01/starter-3_gr.png">
      </div>
    </div>
...
НАЙ-ЛЕСНОТО И СИГУРНО НАЧАЛО
      ...
      <div style="margin-left: 20px;" class="why-point">
        ...
        <p class="description">Защото ви позволява да опознаете качеството без голяма инвестиция. Вместо да купувате много артикули предварително, получавате една тениска и един боксер - точно достатъчно, за да видите как пасват, как се носят и какъв е материалът.

</p>
      </div>

      <div style="margin-left: 20px;" class="why-point">
        <p><strong>Перфектният начин да започнете


</strong></p>
        <p class="description">Стартовият пакет е създаден като първо преживяване, а не като запас. Той е наличен само веднъж на клиент на специална цена, така че решението да е просто и без второ обмисляне.
      ...
      <div style="margin-left: 20px;" class="why-point">
        <p><strong>Преживяване, към което се връщате


</strong></p>
        <p class="description">Повечето мъже остават с NORIKS, защото разпознават разликата в кройката, комфорта и качеството. Но първата стъпка е точно тази - минимален риск, ясно впечатление.
</p>
      </div>
    </div>
    ...
    <div class="why-col">
      <div class="video-wrapper">
        <video
          ...
          class="why-video">
          <source src="https://noriks.com/bg/wp-content/uploads/2025/09/noriks_gif_gr_2-1.mp4" type="video/mp4">
  ...
  <div class="container why-container">
    ...
    <div class="why-col">
      <div class="video-wrapper">
          <img style="width: 100%;
    aspect-ratio: 1/1;
    object-fit: cover;  " src="/bg/wp-content/themes/noriks/img/majice-3 (1).jpeg">
      </div>
    </div>
...
<section  style="background: white;" class="why-section">
  <div class="container why-container">
    ...
    <!-- Left Video -->
    <div class="why-col">
       <img src="https://noriks.com/bg/wp-content/uploads/2026/01/prednosti-in-lastnosti2_gr.png">
    </div>
