...
<style>
 ...
 <section class=" features2" aria-label="Prednosti">
  ...
  <img src="/bg/wp-content/themes/noriks/img/cod_icon_.png" alt="Customer Support Icon" class="feature__icon info-icon">
          <p class="feature__text">Наложен платеж</p>
        </div>
        
        
        <div class="feature">
      <img src="https://noriks.com/bg/wp-content/uploads/2025/07/footer_icon1-1.png" alt="Shirt Icon" class="feature__icon info-icon">
          <p class="feature__text">Опитайте 30 дни, без риск</p>
        </div>
        ...
        <img src="https://noriks.com/bg/wp-content/uploads/2025/07/footer_icon3-1.png" alt="Shipping Icon" class="feature__icon info-icon">
          <p class="feature__text">Безплатна доставка за поръчки над 70 лв</p>
        </div>
...
<div class="shipping-box">
  ...
  <p class="shipping-sub">
    Поръчайте в рамките на <span id="midnight-countdown" class="countdown"></span>
  </p>
</div>
...
<script>
  (function () {
    ...
    windowEl.textContent = `Доставка от ${weekdays[first.getDay()]} ${formatDayMonth(first)} до ${weekdays[second.getDay()]}, ${formatDayMonth(second)}`;
...
<br>
     ...
     <div class="accordion-item">
      ...
      <div class="accordion-content">
          ...
          <img src="https://noriks.com/bg/wp-content/uploads/2026/01/boxers_size_GR.png">
        ...
        <?php elseif(  $is_carape ): ?>
                  ...
                  <img src="https://noriks.com/bg/wp-content/uploads/2026/01/Nogavice_tabela_velikosti_GR.png">
                  
    <?php elseif(  $is_mixed_bundle ): ?>
    
     <img src="https://noriks.com/bg/wp-content/uploads/2025/09/noriks_tablica_gr.jpg">
    ...
    <div class="accordion-content">
  <p></p>
  Вярваме толкова много, че ще ви хареса NORIKS, че имате <b data-stringify-type="bold">30 дни</b> за връщане или безплатна замяна.
  ...
  <p>
    Просто ни изпратете имейл, че искате замяна и <b data-stringify-type="bold">ние я уреждаме веднага.</b>
  </p>
</div>
