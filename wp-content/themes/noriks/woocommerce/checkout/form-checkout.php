...
<form name="checkout" method="post" class="checkout woocommerce-checkout"
      action="<?php echo esc_url( wc_get_checkout_url() ); ?>" enctype="multipart/form-data" aria-label="Плащане">
      ...
      <div class="woocommerce-additional-fields">
        ...
        <div id="custom_shipping">
              ...
              <label for="shipping_method_0_standard_custom" class="checkedlabel">
                ...
                <div class="outer-wrapper">
                  ...
                  <div class="inner-wrapper-img">
                    ...
                    <span class="delivery_img"><img decoding="async" class="ekont standard" src="https://images.vigo-shop.com/general/curriers/econt.png" alt="Еконт" style="height:24px;object-fit:contain;"/></span>
                  </div>
                </div>
              </label>
            </li>
          ...
          <div class="delivery-from-eu-warehouse">
            ...
            <span class="delivery-from-eu-warehouse__text">Склад в ЕС</span>
          </div>
        </div>

        <!-- COD prompt -->
        <div id="hs-cod-checkout-prompt" style="display:none;">
          <div class="cod-prompt-text">Завърши поръчката сега, <strong>плати с наложен платеж 🙂</strong></div>
        ...
        <div id="hs-vat-tax-checkout-prompt">
          <span class="tax-and-vat-checkout-claims">Няма допълнителни разходи за мито</span>
...
<div class="checkout-warranty flex flex--center flex--middle">
  <div class="flex__item--autosize checkout-warranty__icon">
    <img decoding="async" src="https://images.vigo-shop.com/general/guarantee_money_back/satisfaction_icon_bg.png">
  </div>
  <div class="flex__item--autosize f--m checkout-warranty__text">
    <strong>Купете без притеснения </strong><br>Възстановяване на сумата е възможно в срок до 90 дни
  </div>
</div>
