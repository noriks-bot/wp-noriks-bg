...
<div class="checkout-warranty flex flex--center flex--middle">
  ...
  <div class="flex__item--autosize f--m checkout-warranty__text">
    <strong>Пазарувайте спокойно </strong><br>Връщане на парите е възможно до 90 дни
  </div>
</div>

<!-- Terms -->
<div class="agreed_terms_txt">
  <span class="policy-agreement-obligation">С натискането на бутона <strong>Поръчай</strong> потвърждавам поръчка с ангажимент за плащане.</span><br>
