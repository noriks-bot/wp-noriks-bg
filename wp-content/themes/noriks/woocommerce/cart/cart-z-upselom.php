...
$TRIGGER_CATEGORY_SLUGS = array_values( array_unique( array_merge( noriks_term_slugs( 'boxers' ), noriks_term_slugs( 'mixed_bundles' ), noriks_term_slugs( 'promo' ), array( 'boxers' ) ) ) );
