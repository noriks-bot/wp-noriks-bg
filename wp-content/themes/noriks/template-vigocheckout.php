...
<div class="before_form container container--xs">
  ...
  <div class="woocommerce-billing-fields__field-wrapper">
    <p class="form-row form-row-first form-group col-xs-12 validate-required" id="billing_first_name_field" data-priority="30"><label for="billing_first_name" class="required_field">Име&nbsp;<span class="required" aria-hidden="true">*</span></label><span class="woocommerce-input-wrapper"><input type="text" class="input-text form-input" name="billing_first_name" id="billing_first_name" placeholder="Име"  value="" aria-required="true" maxlength="80" autocomplete="given-name" /></span></p><p class="form-row form-row-last form-group col-xs-12 validate-required" id="billing_last_name_field" data-priority="40"><label for="billing_last_name" class="required_field">Фамилия&nbsp;<span class="required" aria-hidden="true">*</span></label><span class="woocommerce-input-wrapper"><input type="text" class="input-text form-input" name="billing_last_name" id="billing_last_name" placeholder="Фамилия"  value="" aria-required="true" maxlength="80" autocomplete="family-name" /></span></p><div class="form-row form-row-wide col-xs-12">Въведете адрес, на който ще бъдете <b>между 8:00 и 16:00 ч.</b></div><p class="form-row form-row-wide address-field form-group form-group col-xs-12 validate-required" id="billing_address_1_field" data-priority="50"><label for="billing_address_1" class="required_field">Улица&nbsp;<span class="required" aria-hidden="true">*</span></label><span class="woocommerce-input-wrapper"><input type="text" class="input-text form-input" name="billing_address_1" id="billing_address_1" placeholder="Улица"  value="" aria-required="true" maxlength="80" autocomplete="address-line1" /></span></p><p class="form-row form-row-wide address-field form-group form-group col-xs-12 validate-required" id="billing_address_2_field" data-priority="60"><label for="billing_address_2" class="screen-reader-text required_field">Номер&nbsp;<span class="required" aria-hidden="true">*</span></label><span class="woocommerce-input-wrapper"><input type="text" class="input-text form-input" name="billing_address_2" id="billing_address_2" placeholder="Номер"  value="" autocomplete="address-line2" maxlength="80" aria-required="true" /></span></p><p class="form-row form-row-wide address-field form-group form-group col-xs-12 validate-required validate-postcode" id="billing_postcode_field" data-priority="70"><label for="billing_postcode" class="required_field">Пощенски код&nbsp;<span class="required" aria-hidden="true">*</span></label><span class="woocommerce-input-wrapper"><input type="tel" class="input-text form-input" name="billing_postcode" id="billing_postcode" placeholder="Пощенски код"  value="" aria-required="true" maxlength="30" autocomplete="postal-code" /></span></p><p class="form-row form-row-wide dropdown form-group form-group col-xs-12 validate-required" id="billing_city_field" data-priority=""><label for="billing_city" class="required_field">Град&nbsp;<span class="required" aria-hidden="true">*</span></label><span class="woocommerce-input-wrapper"><select name="billing_city" id="billing_city" class="select form-input" aria-required="true" data-allow_clear="true" data-placeholder="Изберете град">
							<option value=""  selected='selected'>Изберете град</option>
						</select></span></p><p class="form-row form-row-wide form-group col-xs-12 validate-required validate-phone" id="billing_phone_field" data-priority="10"><label for="billing_phone" class="required_field">Telefon&nbsp;<span class="required" aria-hidden="true">*</span></label><span class="woocommerce-input-wrapper"><input type="tel" class="input-text form-input" name="billing_phone" id="billing_phone" placeholder="Мобилен телефонен номер"  value="" maxlength="17" aria-required="true" autocomplete="tel" /></span></p><p class="form-row form-row-wide form-group col-xs-12 validate-email" id="billing_email_field" data-priority="20"><label for="billing_email" class="">Имейл адрес&nbsp;<span class="optional">(по избор)</span></label><span class="woocommerce-input-wrapper"><input type="email" class="input-text form-input" name="billing_email" id="billing_email" placeholder="Имейл адрес"  value="" maxlength="80" autocomplete="email" /></span></p><p class="form-row form-row-wide address-field form-group col-xs-12 validate-state" id="billing_state_field" data-priority="80"><label for="billing_state" class="">Област&nbsp;<span class="optional">(по избор)</span></label><span class="woocommerce-input-wrapper"><select name="billing_state" id="billing_state" class="state_select form-input" autocomplete="address-level1" data-placeholder="placeholder_province"  data-input-classes="form-input" data-label="Област">
						<option value="">Изберете опция&hellip;</option><option value="HR-01" >Zagreb County</option><option value="HR-02" >Krapina-Zagorje County</option><option value="HR-03" >Sisak-Moslavina County</option><option value="HR-04" >Karlovac County</option><option value="HR-05" >Varaždin County</option><option value="HR-06" >Koprivnica-Križevci County</option><option value="HR-07" >Bjelovar-Bilogora County</option><option value="HR-08" >Primorje-Gorski Kotar County</option><option value="HR-09" >Lika-Senj County</option><option value="HR-10" >Virovitica-Podravina County</option><option value="HR-11" >Požega-Slavonia County</option><option value="HR-12" >Brod-Posavina County</option><option value="HR-13" >Zadar County</option><option value="HR-14" >Osijek-Baranja County</option><option value="HR-15" >Šibenik-Knin County</option><option value="HR-16" >Vukovar-Srijem County</option><option value="HR-17" >Split-Dalmatia County</option><option value="HR-18" >Istria County</option><option value="HR-19" >Dubrovnik-Neretva County</option><option value="HR-20" >Međimurje County</option><option value="HR-21" >Zagreb City</option></select></span></p><p class="form-row form-row-wide address-field update_totals_on_change form-group col-xs-12 validate-required" id="billing_country_field" data-priority="90"><label for="billing_country" class="required_field">Country / Region&nbsp;<span class="required" aria-hidden="true">*</span></label><span class="woocommerce-input-wrapper"><strong>България</strong><input type="hidden" name="billing_country" id="billing_country" value="BG" aria-required="true" autocomplete="do-not-autofill" class="country_to_state" readonly="readonly" /></span></p><p class="form-row kl_newsletter_checkbox_field form-group col-xs-12" id="kl_newsletter_checkbox_field" data-priority=""><span class="woocommerce-input-wrapper"><label class="checkbox " ><input type="checkbox" name="kl_newsletter_checkbox" id="kl_newsletter_checkbox" value="1" class="input-checkbox form-input"  /> Запишете ме за новини и оферти по имейл&nbsp;<span class="optional">(по избор)</span></label></span></p><p class="form-row form-row-wide hsplus-checkout-field hsplus-checkout-field--no-top-margin hsplus-checkout-field--hidden" id="hsplus_accepts_marketing_field" data-priority="11"><span class="woocommerce-input-wrapper"><label class="checkbox " ><input type="checkbox" name="hsplus_accepts_marketing" id="hsplus_accepts_marketing" value="1" class="input-checkbox woocommerce-form__input woocommerce-form__input-checkbox hsplus-checkbox"  /> Запишете ме за ексклузивни оферти и новини чрез SMS&nbsp;<span class="optional">(по избор)</span></label></span></p>  </div>
...
<div class="woocommerce-additional-fields">
		...
		<div class="woocommerce-additional-fields__field-wrapper">
							<p class="form-row notes form-group col-xs-12" id="order_comments_field" data-priority=""><label for="order_comments" class="">Бележки към поръчката&nbsp;<span class="optional">(по избор)</span></label><span class="woocommerce-input-wrapper"><textarea name="order_comments" class="input-text form-input" id="order_comments" placeholder="Бележки към вашата поръчка.  "  rows="2" cols="5"maxlength="80"></textarea></span></p>					</div>
        ...
        <ul class="shipping_method_custom">
                ...
                <label
                    ...
                    <svg viewBox="0 0 19 14" fill="#3DBD00"><path fill-rule="evenodd" clip-rule="evenodd" d="M18.5725 3.40179L8.14482 13.5874C7.5815 14.1375 6.66839 14.1375 6.1056 13.5874L0.422493 8.03956C-0.140831 7.48994 -0.140831 6.59748 0.422493 6.04707L1.44121 5.05126C2.00471 4.50094 2.91854 4.50094 3.48132 5.05126L7.12254 8.60835L15.5145 0.412609C16.078 -0.137536 16.9909 -0.137536 17.5537 0.412609L18.5733 1.40842C19.1424 1.95795 19.1424 2.8505 18.5725 3.40179Z" /></svg>                                        <div class="outer-wrapper">
                        ...
                        <strong
                            class="hs-custom-date">сряда, 18.3. - четвъртък, 19.3.</strong>
                        </div>
...
<p class="ql-align-justify">Потвърждението на Общите условия при извършване на поръчка в нашия онлайн магазин представлява обвързващ договор между вас и компанията. Моля, <strong>прочетете внимателно</strong> Общите условия <strong>преди да потвърдите поръчката</strong>. Ако не сте съгласни с нашите Общи условия, не можете да използвате услугите, предлагани от нашия онлайн магазин. Също така не е възможно частично съгласие с Общите условия. За да завършите покупката, трябва да приемете <strong>изцяло</strong> Общите условия, валидни към момента на покупката.</p>
...
<p class="ql-align-justify"><strong>България</strong></p>
    ...
    <div class="inner_wrapper">
        ...
        <div class="partial_inner_section">
            ...
            <div class="text_wrapper">
                ...
                <div class="text_wrapper">Плащане при доставка</div>
            </div>
            ...
            <div class="text_wrapper delivery-from-eu-warehouse__text">Склад в ЕС</div>
        </div>
            </div>
</div>
...
document.addEventListener('DOMContentLoaded', function () {
  var replacements = new Map([
    ...
    ['Telefon', 'Телефон'],
    ['Мобилен телефонен номер', 'Телефонен номер'],
    ['Имейл адрес', 'Имейл адрес'],
    ['Област', 'Област'],
    ['Odaberite opciju…', 'Изберете опция…'],
    ['Hrvatska', 'България'],
    ['(по избор)', '(по избор)'],
    ['Запишете ме за новини и оферти по имейл', 'Искам да получавам новини и оферти по имейл'],
    ['Запишете ме за ексклузивни оферти и новини чрез SMS', 'Запишете ме за ексклузивни оферти и новини чрез SMS'],
    ['Бележки към поръчката', 'Бележки към поръчката'],
    ['Бележки към вашата поръчка.', 'Бележки за вашата поръчка.'],
    ...
    ['Molimo, požuri! Netko je upravo naručio jedan od proizvoda u tvojoj košarici.', 'Моля, побързай! Някой току-що поръча един от продуктите в твоята количка.'],
    ['Rezervacija velja samo še', 'Резервацията е валидна само още'],
    ['Plaćanje pouzećem', 'Плащане при доставка'],
    ['Skladište u EU', 'Склад в ЕС'],
    ['Dostavlja: Paket24 Hrvatske pošte', 'Доставя се от: Paket24 Hrvatska pošta'],
    ['Kupi zajedno i uštedi:', 'Купи заедно и спести:'],
    ['Odstrani', 'Премахни'],
    ['Dostava in pošiljanje', 'Доставка и изпращане'],
    ['Molimo, požuri! Netko je upravo naručio jedan od proizvoda u tvojoj košarici. Rezervacija velja samo še 10:00 minut.', 'Моля, побързай! Някой току-що поръча един от продуктите в твоята количка. Резервацията е валидна само още 10:00 минути.'],
