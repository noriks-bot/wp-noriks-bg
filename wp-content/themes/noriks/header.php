...
<div id="page" class="hfeed site">
  ...
  <div class="marquee">
    <div class="marquee-content">
      <span><a href="/bg/shop">Безплатна доставка за поръчки над 70 €</a></span>
      <span><a href="/bg/shop">30 дни без риск – пробвай спокойно</a></span>
      <!--<span><a href="/bg/shop">Zimska ponuda: Do 70% popusta!</a></span>-->
        ...
        <?php foreach ($header_nav as $item): ?>
            ...
            <?php if ($i === 0): ?>
                ...
                <div class="nav-item has-dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="/bg/shop">Създай своя пакет</a>
                        <a href="/bg/product-category/bundles/">Готови пакети</a>
                    </div>
                    -->
                </div>
            ...
            <?php elseif ($i === 1): ?>
                ...
                <div class="nav-item has-dropdown">
                    ...
                    <!--
                    <div class="dropdown-menu">
                        <a href="/bg/product-category/bokserice-sastavi-paket/">Създай своя пакет</a>
                        <a href="/bg/product-category/bokserice/">Готови пакети</a>
                    </div>
                    -->
                </div>
