		...
		<div class="header__inner">
			<div class="header__content container">
				...
				<ul class="header__menu">
					...
					<li class="header__menu-item"><a class="header__menu-link link--nu" href="https://ortowp.noriks.com/trgovina/">Всички продукти</a></li>
				</ul>
...
<div class="quantity-banner">Najbolj&#x161;a ponudba</div>
        ...
        <style>
          ...
          <div class="related-product-wrapper">
            <span class="related-product-text">Купи заедно и спести:</span>
                ...
                <label class="related-product-container">
                  ...
                  <span class="checkmark" id="checkmark-rp-0">
                    <p>
                      ...
                      <span class="remove-upsell-icon"><img src="https://images.hs-plus.com/assets/shared-images/acedd549f8a4b_remove-from-cart.svg"></span>Премахни</span>
                    </p>
                  </span>
                </label>
              </div>
						...
						<details class="acrd__item">
							<summary>
								<div class="acrd__heading">
									...
									<span>Доставка и изпращане</span>
								</div>
							</summary>
							<div class="acrd__body">
							...
							<div class="swiper-wrapper">
								...
								<div class="swiper-slide loockat-slider__item loockat-card">
									...
									<div class="loockat-card__info">
										...
										<h4 class="loockat-card__title">Градbeni delavec</h4>
    ...
    <div class="review-modal-content">
        ...
        <div class="review-modal-body">
            ...
            <form id="review-form" action="https://diwpk57gr7.execute-api.eu-central-1.amazonaws.com/prod/submitReview" enctype="multipart/form-data" method="POST" target="formFrame">
                <p><label class="review-form__label" for="name">Име:</label></p>
                <p><input class="review-form__input" name="name" type="text" maxlength="40" placeholder="Име (видимо публично)" required></p>
                <p><label class="review-form__label" for="email">E-mail:</label></p>
                <p><input class="review-form__input" name="email" maxlength="60" type="email" placeholder="Имейл (не е видим публично)" required></p>
                <p><label class="review-form__label">Оценка:</label></p>
                <div class="rate">
...
<!-- <a href="https://manuals.hs-plus.com/si?brand=stepease">Navodila za uporabo</a> --></div>
	...
	<section class="sct-bar bottom-sticky-bar" id="bottomStickyBar">
		<div class="sct-bar__content container">
			...
			<!-- <button class="btn btn--bg sct-bar__btn" onclick="submitproductform()"><span>Поръчай сега</span></button> -->
			<!-- <a class="btn btn--bg sct-bar__btn" data-scroll=".scroll-target" data-scroll-offset="120" href="#">Поръчай сега</a> -->
		</div>
	</section>
...
/*   var dateValues = {
    text: 'Поръчай сега и ще получиш в ',
