...
get_header(); ?>
  ...
  <div class="hero__content">
    ...
    <a class="hero__btn" href="/bg/shop">ПАЗАРУВАЙ СЕГА</a>
  </div>
</section>
...
@media (max-width: 640px) {
  ...
  <div class="collections__header">
    <h2 class="collections__title">Пазарувай по колекция</h2>
      ...
      <div class="collection-card__body">
        <div class="collection-card__text">
          ...
          <p class="collection-card__desc">
           Комфорт през целия ден. Без стягане.
          </p>
        </div>
    ...
    <a class="collection-card" href="https://noriks.com/bg/product-category/komplekti/?yith_wcan=1&product_cat=startovi-paketi&orderby=popularity">
      ...
      <div class="collection-card__body">
        <div class="collection-card__text">
          ...
          <p class="collection-card__desc">
Изпробвай NORIKS на по-добра начална цена.
                  ...
                  if ( $alt_output == false ):
                    ...
                    if ( $is_boxers ):
                      if ( has_term('black-friday', 'product_cat', $current_product_id ) ):
                        ...
                        $topseler_text = get_field("singlepp_priceper_before","options") . " " . $tmp_price . " " . "€ на боксерка";
                      endif;
                    else:
