...
if (!function_exists('noriks_customize_step_landing_markup')) {
    function noriks_customize_step_landing_markup($markup, $landing_url, $cart_url, $home_url, $boxers_image_url, $hero_image_url, $landing_image_urls, $review_image_urls, $purpose_image_urls) {
        ...
        $markup = str_replace(
            ...
            array(
                '<img class="related-product-image" src="' . esc_url($boxers_image_url) . '" alt="NORIKS боксерки">',
        ...
        $text_replacements = array(
            ...
            'Ali se STEPEASE prilegajo mojim &#x10D;evljem?' => 'Подхожда ли ми тениска NORIKS?',
            'Ali se STEPEASE prilegajo mojim čevljem?' => 'Подхожда ли ми тениска NORIKS?',
            'Kako dolgo zdr&#x17E;ijo vlo&#x17E;ki STEPEASE?' => 'Kako dolgo traju NORIKS majice?',
            'Kako dolgo zdržijo vložki STEPEASE?' => 'Kako dolgo traju NORIKS majice?',
            'Domov' => 'Početna',
            'Всички продукти' => 'Svi proizvodi',
            ...
            'OrthoStep &raquo; STEPEASE Vir komentarjev' => 'NORIKS &raquo; NORIKS Източник на отзиви',
            ...
            'Pravilna opora loka spodbuja bolj&#x161;o poravnavo hrbtenice.' => 'Добре скроената тениска осигурява по-чист вид и по-добра силуета.',
            ...
            'Dostava in pošiljanje' => 'Доставка и изпращане',
            'Politika vra&#x10D;il in povra&#x10D;il' => 'Политика за връщане и възстановяване',
            'Politika vračil in povračil' => 'Политика за връщане и възстановяване',
            'Popust za razli&#x10D;ne velikosti' => 'Отстъпка за различни размери',
            'Popust za različne velikosti' => 'Отстъпка за различни размери',
            'Na&#x161; popust lahko uporabite tudi za razli&#x10D;ne barve in velikosti!' => 'Нашата отстъпка може да се използва и за различни цветове и размери!',
            'Postopek:' => 'Postupak:',
            ...
            'Popust za 2,&#xA0;3&#xA0;ali&#xA0;5&#xA0;parov se bo samodejno obra&#x10D;unal pri skupni ceni.' => 'Отстъпката за 2, 3 или 5 броя ще бъде автоматично изчислена в общата цена.',
            ...
            'Prepri&#x10D;ani smo, da vam bo udobje vlo&#x17E;kov STEPEASE v&#x161;e&#x10D;. Zato ponujamo 90&#x2011;dnevno garancijo vra&#x10D;ila denarja brez tveganja. &#x10C;e ne boste popolnoma zadovoljni, nam preprosto pi&#x161;ite in uredili bomo vra&#x10D;ilo.' => 'Уверени сме, че ще ви хареса комфортът на NORIKS тениските. Затова предлагаме 90-дневна гаранция за връщане на парите без риск. Ако не сте напълно доволни, просто се свържете с нас и ще уредим връщането.',
            'Olaj&#x161;aj</span> bole&#x10D;ine v stopalih' => 'Istakni</span> svoj stil',
            'Olajšaj</span> bolečine v stopalih' => 'Istakni</span> svoj stil',
            'Prihodnost je </span>brez bole&#x10D;in v stopalih' => 'Бъдещето е </span>в NORIKS тениските',
            'Prihodnost je </span>brez bolečin v stopalih' => 'Бъдещето е </span>в NORIKS тениските',
            ...
            'Ne glede na to, ali ste zaposlen strokovnjak ali športnik, ki premika svoje meje – ortopedski vložki z masažnimi točkami STEPEASE vam zagotavljajo vrhunsko oporo in olajšanje. Vzemite si trenutek zase, vložite v udobje in občutite razliko na lastnih stopalih.' => 'Bez obzira trebaš li majicu za svaki dan ili za poseban outfit, NORIKS majice donose udobnost, bolji fit i sigurniji izgled. Uzmi trenutak za sebe i odaberi model koji ti najbolje pristaje.',
            'Preizkusite spremembo na lastnih stopalih in zakorakajte v svetlej&#x161;o, nebole&#x10D;o prihodnost &#x17E;e danes.' => 'Опитайте разликата сами и открийте колко една добра тениска може да промени целия вид на аутфита.',
            'Preizkusite spremembo na lastnih stopalih in zakorakajte v svetlejšo, nebolečo prihodnost že danes.' => 'Опитайте разликата сами и открийте колко една добра тениска може да промени целия вид на аутфита.',
            ...
            'Preizkusil sem ne&#x161;teto vlo&#x17E;kov, a nobeni se ne morejo primerjati s&#xA0;STEPEASE. Razlika v udobju in po&#x10D;utju je res opazna.' => 'Пробвал съм много обикновени тениски, но NORIKS е далеч над всичко, което съм носил преди. Материалът, кройката и усещането върху тялото се забелязват веднага.',
            'Svoje dni pre&#x17E;ivim na betonskih tleh v delovnih &#x10D;evljih s kovinsko kapico. Ortopedski vlo&#x17E;ki z masa&#x17E;nimi to&#x10D;kami | STEPEASE odli&#x10D;no bla&#x17E;ijo udarce in nudijo podporo, kar zmanj&#x161;uje obremenitev stopal in sklepov. Presene&#x10D;en sem, koliko so mi pomagali &#x2013; o njih sem povedal vsem sodelavcem.' => 'Имам взискателна работа и имам нужда от дрехи, които изглеждат добре дори в дългите дни. NORIKS тениската запазва формата си, удобна е за носене и изглежда достатъчно добре, че я препоръчах и на колегите.',
            'Kot medicinska sestra sem ves dan na nogah. Ko sem jih prvi&#x10D; vstavila, sem takoj za&#x10D;utila razliko. Podpora loka je odli&#x10D;na in prina&#x161;a prepotrebno olaj&#x161;anje. Mehka blazina popolno ubla&#x17E;i stalne pritiske na stopala.' => 'Като медицинска сестра имам нужда от дрехи, които са удобни и надеждни цял ден. NORIKS тениската е мека, пасва добре и наистина изглежда страхотно дори след дълга смяна.',
            'Vau, ti vlo&#x17E;ki so presegli vsa moja pri&#x10D;akovanja! Po dveh dneh no&#x161;enja med 12-urnimi izmenami sem ugotovil, da so resni&#x10D;no izjemni. So izredno udobni, nudijo oporo ves dan &#x2013; naro&#x10D;il sem &#x161;e dva para!' => 'Тази тениска надмина очакванията ми. След няколко дълги дни на носене ми стана ясно, че искам още, затова веднага поръчах допълнителни цветове.',
            'Sem predan teka&#x10D; in preizkusil sem &#x17E;e veliko vlo&#x17E;kov. Odkar uporabljam ortopedske vlo&#x17E;ke z masa&#x17E;nimi to&#x10D;kami STEPEASE, opa&#x17E;am bolj&#x161;o zmogljivost in hitrej&#x161;e okrevanje. Toplo priporo&#x10D;am vsem teka&#x10D;em, ki &#x17E;elijo izbolj&#x161;ati rezultate in za&#x161;&#x10D;ititi svoja stopala.' => 'Активен съм и обичам дрехи, които изглеждат чисто и спортно, но все пак достатъчно сериозно за всеки ден. NORIKS тениската стана първият ми избор, защото изглежда страхотно и лесно се комбинира.',
            ...
            'Vir komentarjev' => 'Източник на отзиви',
...
$boxers_image_url   = 'https://noriks.com/bg/wp-content/uploads/2025/11/boksarice_3x_crne-600x600.png';
...
$review_image_urls = array(
    'https://noriks.com/bg/wp-content/themes/noriks/auto_reviews/majice-slike/Generated%20Image%20January%2019%2C%202026%20-%2010_41AM.jpeg',
    'https://noriks.com/bg/wp-content/themes/noriks/auto_reviews/majice-slike/Generated%20Image%20January%2019%2C%202026%20-%2010_39AM.jpeg',
    'https://noriks.com/bg/wp-content/themes/noriks/auto_reviews/majice-slike/Generated%20Image%20January%2019%2C%202026%20-%2010_29AM.jpeg',
    'https://noriks.com/bg/wp-content/themes/noriks/auto_reviews/majice-slike/Generated%20Image%20January%2019%2C%202026%20-%2010_30AM%20%281%29.jpeg',
    'https://noriks.com/bg/wp-content/themes/noriks/auto_reviews/majice-slike/Generated%20Image%20January%2019%2C%202026%20-%2010_45AM.jpeg',
    'https://noriks.com/bg/wp-content/themes/noriks/auto_reviews/majice-slike/Generated%20Image%20January%2019%2C%202026%20-%2010_52AM.jpeg',
    'https://noriks.com/bg/wp-content/themes/noriks/auto_reviews/majice-slike/Generated%20Image%20January%2019%2C%202026%20-%2010_50AM.jpeg',
);
$purpose_image_urls = array(
    'https://noriks.com/bg/wp-content/uploads/2025/11/crna-in-siva-majica-vse-barve-gat-bundle-600x600.png',
    'https://noriks.com/bg/wp-content/uploads/2025/11/crna-in-modra-majica-vse-barve-gat-bundle-600x600.png',
    'https://noriks.com/bg/wp-content/uploads/2025/11/crna-in-bela-majica-vse-barve-gat-bundle-600x600.png',
    'https://noriks.com/bg/wp-content/uploads/2025/11/bela-in-siva-majica-vse-barve-gat-bundle-600x600.png',
    'https://noriks.com/bg/wp-content/uploads/2025/09/monochrome-3x-600x600.jpg',
    'https://noriks.com/bg/wp-content/uploads/2025/09/city-6x-600x600.jpg',
    'https://noriks.com/bg/wp-content/uploads/2025/09/everyday-6X-600x600.jpg',
    'https://noriks.com/bg/wp-content/uploads/2025/09/urban-earth-6x-600x600.jpg',
);

if (!$target_product_url) {
    $target_product_url = home_url('/bg/product/noriks-majica/');
}
